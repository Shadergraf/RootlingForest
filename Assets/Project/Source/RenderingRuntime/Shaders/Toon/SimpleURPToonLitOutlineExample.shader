...
Shader "SimpleURPToonLitExample(With Outline)"
{
    Properties
    {
        ...
        _OutlineDistanceScale("Distance Scale", Range(0.01, 2)) = 1
        _OutlineColor("Color", Color) = (0.5,0.5,0.5,1)
        [HDR] _OutlineEmissionColor("Emission Color", Color) = (2,2,2,1)
    ...
    {       
        ...
        Pass
        {
            ...
            //#define ToonShaderApplyShadowBiasFix      // Causes issues with lights that are positioned inside geometry (even with clipping enabled)
