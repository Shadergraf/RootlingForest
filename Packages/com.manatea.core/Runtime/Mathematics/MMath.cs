...
namespace Manatea
{
	public static class MMath
	{
		...
		/// <inheritdoc cref="MMath.Lerp(Vector2,Vector2,Vector2)"/>
		...
		/// <inheritdoc cref="MMath.InverseLerp(Vector2,Vector2,Vector2)"/>
		...
		/// <inheritdoc cref="MMath.Damp"/>
		public static Vector2 Damp(Vector2 current, Vector2 target, [Uei.DefaultValue("Mathf.Infinity")] float smoothTime, [Uei.DefaultValue("Time.deltaTime")] float deltaTime)
			=> Vector2.Lerp(current, target, 1 - Exp(-smoothTime * deltaTime));
		/// <inheritdoc cref="MMath.Damp"/>
		public static Vector3 Damp(Vector3 current, Vector3 target, [Uei.DefaultValue("Mathf.Infinity")] float smoothTime, [Uei.DefaultValue("Time.deltaTime")] float deltaTime)
			=> Vector3.Lerp(current, target, 1 - Exp(-smoothTime * deltaTime));
		/// <inheritdoc cref="MMath.Damp"/>
		public static Vector4 Damp(Vector4 current, Vector4 target, [Uei.DefaultValue("Mathf.Infinity")] float smoothTime, [Uei.DefaultValue("Time.deltaTime")] float deltaTime)
			=> Vector4.Lerp(current, target, 1 - Exp(-smoothTime * deltaTime));
		/// <inheritdoc cref="MMath.Damp"/>
		public static Quaternion Damp(Quaternion current, Quaternion target, [Uei.DefaultValue("Mathf.Infinity")] float smoothTime, [Uei.DefaultValue("Time.deltaTime")] float deltaTime)
			=> Quaternion.Lerp(current, target, 1 - Exp(-smoothTime * deltaTime));
		/// <inheritdoc cref="MMath.Damp"/>
		public static Color Damp(Color current, Color target, [Uei.DefaultValue("Mathf.Infinity")] float smoothTime, [Uei.DefaultValue("Time.deltaTime")] float deltaTime)
			=> Color.Lerp(current, target, 1 - Exp(-smoothTime * deltaTime));
		...
		/// <summary>Returns the average/center of the the input vectors</summary>
		...
		/// <seealso cref="MMathExtensions.Angle"/>
